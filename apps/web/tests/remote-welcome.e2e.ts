// A trusted non-loopback browser is an ordinary authenticated client of the
// settings API, so its acknowledgement lands in the Host document and the
// notice stays dismissed across a reload.
...
describe.skipIf(MODE === 'record')('web e2e: remote welcome notice', () => {
  ...
  it('records the acknowledgement durably and stays dismissed after reload', async () => {
