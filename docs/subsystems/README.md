...
| [cron.md](cron.md) | Host-scheduled run results and durable delivery acknowledgment |
...
| [speech.md](speech.md) | the speech seam: `ctx.speech`, the buffered config and streaming intake routes, FFmpeg decoding, and the whisper.cpp backend |
