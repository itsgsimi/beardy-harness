...
Source: [`packages/preset/agent-presets/src/preset.ts:57`](../packages/preset/agent-presets/src/preset.ts)
...
Requires: `agentDefaultModel` · `agentPresets` · `agents` · `commands` · `permissionPresets` · `sessionTitle` · `storageDomain` · `tools` · `workspaceRegistry`
...
Requires: `agentDefaultModel` · `agentPresets` · `agents` · `commands` · `credentials` · `permissionPresets` · `sessionTitle` · `storageDomain` · `sessions` · `sessionPersistence` · `workspaceRegistry`
...
Source: [`packages/speech/speech-whisper/src/index.ts:10`](../packages/speech/speech-whisper/src/index.ts)
...
Source: [`packages/discord/tool-discord/src/index.ts:42`](../packages/discord/tool-discord/src/index.ts)
...
Requires: `tools` · `credentials` · `settings`
...
Source: [`packages/skill/tool-skill/src/index.ts:72`](../packages/skill/tool-skill/src/index.ts)
