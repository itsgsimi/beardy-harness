...
| `ctx.speech` | `seam` | [`speech-whisper`](../packages/speech/speech-whisper) | [`speech-whisper`](../packages/speech/speech-whisper) | [`discord-gateway`](../packages/discord/discord-gateway) | - | Bounded encoded audio is decoded through the managed subprocess service and posted to a configured whisper.cpp endpoint; consumers submit the recognized text through ordinary session input. |
