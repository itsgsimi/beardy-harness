...
| `event:agent/inbox/spliced` | event | `9c01f7b934cf6469a1f56a74014932f8ec11ebf2381587442aa86ad729516cf1` | [`event:agent/inbox/spliced`](#persistence-type-eventagentinboxspliced) |
...
| `event:deliverables/presented` | event | `c63a3a594df4cfda0975b91dad916d6bb62f83058fb48a049a6c923495c5561c` | [`event:deliverables/presented`](#persistence-type-eventdeliverablespresented) |
...
| `event:session/title-llm-request` | event | `c9a12d5f0ef762901d655f4aa638d7729a0ea0796d070684876124b791ce4a3d` | [`event:session/title-llm-request`](#persistence-type-eventsessiontitle-llm-request) |
...
| `event:user/message` | event | `5b481fa5bebd5721af413e5326b75d9e9400503b13a45542cc820345bc3b0a99` | [`event:user/message`](#persistence-type-eventusermessage) |
...
Source: [`packages/fs/tool-present/src/types.ts:27`](../packages/fs/tool-present/src/types.ts)
...
<a id="persistence-type-discord"></a>
...
SHA-256: `9c01f7b934cf6469a1f56a74014932f8ec11ebf2381587442aa86ad729516cf1`
...
SHA-256: `643117adfb1fbe8dbab6fd56a45077e5a168edb6b8ec591d912838cd2b90c188`
...
SHA-256: `335190cef4bfc7736574e7f5a776401546c83c9abb3992f2191a2f51b696f1d0`
...
Sources: [`packages/discord/discord-gateway/src/types.ts:13`](../packages/discord/discord-gateway/src/types.ts)
...
Sources: [`packages/cron/cron/src/types.ts:10`](../packages/cron/cron/src/types.ts)
...
| `kind` | required | `"cron"` |
| `scheduledFor` | required | `number` |
| `summary` | required | `string` |

<a id="persistence-type-eventagentinboxspliceddatainserted0source17references"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[17].references`

SHA-256: `df843efd87c78cf8de98f8e0d0216956cd568d0d0e56a22c853663e274aa1a18`

Array of [`event:agent/inbox/spliced.data.inserted[0].source[17].references[0]`](#persistence-type-eventagentinboxspliceddatainserted0source17references0).

<a id="persistence-type-eventagentinboxspliceddatainserted0source17references0"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[17].references[0]`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source18frozenuserglobalinstructions"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[18].frozenUserGlobalInstructions`

SHA-256: `842a59013906b581b59a62e61f2fb27a67cc47ca5ebdd5f55e30484ca3966f03`

| Property | Presence | Type |
|---|---|---|
| [`string`] | index signature | [`event:agent/inbox/spliced.data.inserted[0].source[18].frozenUserGlobalInstructions.[value]`](#persistence-type-eventagentinboxspliceddatainserted0source18frozenuserglobalinstructionsvalue) |

<a id="persistence-type-eventagentinboxspliceddatainserted0source18frozenuserglobalinstructionsvalue"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[18].frozenUserGlobalInstructions.[value]`
...
Sources: [`packages/skill/tool-skill/src/index.ts:50`](../packages/skill/tool-skill/src/index.ts)

| Property | Presence | Type |
|---|---|---|
| `form` | required | `"notice"` |
| `kind` | required | `"skill-nudge"` |
| `summary` | required | `string` |
...
Sources: [`packages/fs/tool-present/src/types.ts:27`](../packages/fs/tool-present/src/types.ts)
...
<a id="persistence-type-eventdeliverablespresenteddatafiles0visualmediatype"></a>

### `event:deliverables/presented.data.files[0].visual.mediaType`
...
SHA-256: `c9a12d5f0ef762901d655f4aa638d7729a0ea0796d070684876124b791ce4a3d`
...
SHA-256: `2e5b0f31eabf4e1c9bc8d73ea339fe2912f07f23d5243614f08b347e85fbd898`
...
SHA-256: `5b481fa5bebd5721af413e5326b75d9e9400503b13a45542cc820345bc3b0a99`
...
<a id="persistence-type-imagesvgxml"></a>
...
Sources: [`packages/context/agent-instructions/src/state.ts:36`](../packages/context/agent-instructions/src/state.ts)
...
| `form` | required | `"instructions"` |
| `frozenUserGlobalInstructions` | optional | [`event:agent/inbox/spliced.data.inserted[0].source[18].frozenUserGlobalInstructions`](#persistence-type-eventagentinboxspliceddatainserted0source18frozenuserglobalinstructions) |
...
| `references` | required | [`event:agent/inbox/spliced.data.inserted[0].source[17].references`](#persistence-type-eventagentinboxspliceddatainserted0source17references) |
| `version` | required | `1` |
...
| `path` | required | `string` |
| `visual` | optional | [`packages/fs/tool-present/src/types.ts#PresentedVisual`](#persistence-type-packagesfstool-presentsrctypestspresentedvisual) |

<a id="persistence-type-packagesfstool-presentsrctypestspresentedvisual"></a>

### `packages/fs/tool-present/src/types.ts#PresentedVisual`
...
| `mediaType` | required | [`event:deliverables/presented.data.files[0].visual.mediaType`](#persistence-type-eventdeliverablespresenteddatafiles0visualmediatype) |
...
SHA-256: `77d211f311343e5d19b9c986c26ae8235b080e26b1f4f40b0e0ea5fec0073725`
...
SHA-256: `19da62c10946f79e6b1889cc71ebf7441224820333d9797a727928e619a89e55`
...
SHA-256: `ececc85a6b97d2c6d784212fd2e82454e63d2d62baf1d8b5250811dae067c0b4`
...
SHA-256: `2f6a2766d7e5d065101234ef1fbd975483d50cd3507e38e8c7cc2688c88c5ba8`
...
<a id="persistence-type-skill-nudge"></a>
...
<a id="persistence-type-texthtml"></a>
