...
来源：[`packages/discord/discord-gateway/src/types.ts:13`](../packages/discord/discord-gateway/src/types.ts)
...
来源：[`packages/cron/cron/src/types.ts:10`](../packages/cron/cron/src/types.ts)
...
[`event:agent/inbox/spliced.data.inserted[0].source[17].references[0]`](#persistence-type-eventagentinboxspliceddatainserted0source17references0) 的数组。
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| [`string`] | 索引签名 | [`event:agent/inbox/spliced.data.inserted[0].source[18].frozenUserGlobalInstructions.[value]`](#persistence-type-eventagentinboxspliceddatainserted0source18frozenuserglobalinstructionsvalue) |
...
来源：[`packages/skill/tool-skill/src/index.ts:50`](../packages/skill/tool-skill/src/index.ts)
...
| `form` | 必需 | `"instructions"` |
| `frozenUserGlobalInstructions` | 可选 | [`event:agent/inbox/spliced.data.inserted[0].source[18].frozenUserGlobalInstructions`](#persistence-type-eventagentinboxspliceddatainserted0source18frozenuserglobalinstructions) |
...
| `references` | 必需 | [`event:agent/inbox/spliced.data.inserted[0].source[17].references`](#persistence-type-eventagentinboxspliceddatainserted0source17references) |
| `version` | 必需 | `1` |
...
| `path` | 必需 | `string` |
| `visual` | 可选 | [`packages/fs/tool-present/src/types.ts#PresentedVisual`](#persistence-type-packagesfstool-presentsrctypestspresentedvisual) |
...
|---|---|---|
| `data` | 必需 | `string` |
| `mediaType` | 必需 | [`event:deliverables/presented.data.files[0].visual.mediaType`](#persistence-type-eventdeliverablespresenteddatafiles0visualmediatype) |
| `title` | 必需 | `string` |
