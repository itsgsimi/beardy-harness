...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'cordis_undefine', 'create_goal', 'discord_send', 'edit', 'exit_plan_mode', 'get_goal', 'glob', 'grep',
      'interrupt_agent', 'interrupt_agent', 'job_kill', 'job_list', 'job_output',
      'list_agents', 'list_agents', 'list_mcp_resource_templates', 'list_mcp_resources', 'list_subagent_models', 'lsp',
      'memory', 'odysseus_research', 'present', 'present_visual', 'pwsh', 'pwsh',
      'ralph', 'read', 'read_image', 'read_mcp_resource', 'run_code', 'schedule_create',
      'schedule_delete', 'schedule_list', 'send_message', 'send_message', 'session_event_read', 'session_event_search',
      'session_event_trace', 'session_search', 'session_trace', 'skill', 'skill_manage', 'spawn_teammate',
