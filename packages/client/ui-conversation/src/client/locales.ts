...
export const zh = {
  ...
  'research.title': '深度研究',
  'research.open': '打开研究报告',
  'research.report': '研究报告',
  'research.close': '关闭报告',
  'research.download': '下载 Markdown',
  'research.sources': '来源',
  'research.evidence': '模型生成的研究报告。请核实重要结论及来源。',
  'research.copy': '复制代码',
  'research.copied': '已复制',
  'research.footnotes': '脚注',
...
export const en = {
  ...
  'research.open': 'Open research report',
  'research.report': 'Research report',
  'research.close': 'Close report',
  'research.download': 'Download Markdown',
  'research.sources': 'Sources',
  'research.evidence': 'Model-generated research. Verify important claims against the sources.',
  'research.copy': 'Copy code',
  'research.copied': 'Copied',
  'research.footnotes': 'Footnotes',
