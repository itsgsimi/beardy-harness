...
describe('ui-settings-general apply', () => {
  ...
  it('withholds the Host document action off-loopback while settings still read', async ({ mock, start }) => {
    ...
    // surfaces work on a LAN or Tailscale page and adopt the Host preference.
