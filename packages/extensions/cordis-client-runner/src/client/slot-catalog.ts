...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, manual-compaction, model-retry, presented-visual, steering, system-prompt, tool-call, turn-error, turn-max-tokens, turn-process, turn-tail, unknown, user, workflow-run',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-settings-plugins ResearchCard',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: ask_user_question, bash, cordis_define, cordis_run, cordis_stop, cordis_undefine, edit, glob, grep, odysseus_research, present, present_visual, read, read_image, skill, todo_write, web_fetch, web_search, write',
    hookContext: '',
    slotInject: '',
    ...
    occupants: [
      ...
      'client-ui-deliverables PresentRow key \'present_visual\'',
